...
func MostrarMenu(){
	...
	fmt.Println("  *  \x1b[33;1m15 - DOS COMPRAS EN MISMO CP EN MENOS DE 1 MINUTO\x1b[0m          *")
	fmt.Println("  *  \x1b[33;1m16 - DOS COMPRAS EN DISTINTO CP EN MENOS DE 5 MINUTOS\x1b[0m      *")
	fmt.Println("  *  \x1b[33;1m17 - MOSTRAR ALERTAS\x1b[0m                                       *")
	fmt.Println("  *  \x1b[33;1m18 - GENERAR FACTURA\x1b[0m                                       *")
	fmt.Println("  *  \x1b[33;1m19 - SALIR\x1b[0m                                                 *")
	fmt.Println("  *                                                             *")
	fmt.Println("  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *")
	fmt.Println("")
